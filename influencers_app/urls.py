...
urlpatterns = [
    ...
    path('influencers/update/<slug:slug>',
    ...
    path('video/create', views.ContentCreateView.as_view(),
         name='video_create'),
    path('product', views.ArtzProductUSView.as_view(), name='products'),
    path('shipment', views.ShipmentView.as_view(), name='shipment'),
    path('shipment/create', views.ShipmentCreateView.as_view(),
         name='shipment_create'),
    path('shipment/update/<int:pk>', views.ShipmentUpdateView.as_view(),
