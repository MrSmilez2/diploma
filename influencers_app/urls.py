...
urlpatterns = [
    ...
    path('details/', views.InfluencersInformationView.as_view(),
         name='details'),
    path('details/update/<int:pk>', views.InfluencersInformationUpdateView.as_view(),
         name='details_update'),
    ...
    path('shipment/update/<int:pk>', views.ShipmentUpdateView.as_view(), name='shipment_update'),
]
